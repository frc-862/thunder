// package frc.thunder.limelightlib;
...
//     public static Double[] parseLimeLightData(String json, int id) {
//         try {
//             JSONObject j = new JSONObject(json);
//             j = j.getJSONObject("Results");
//             var fiducials = j.getJSONArray("Fiducial");
//             var length = fiducials.length();
//             for (int i = 0; i < length; ++i) {
//                 j = fiducials.getJSONObject(i);
//                 if (j.getLong("fID") == id) {
//                     var pose = j.getJSONArray("t6r_fs");
//                     Double[] result = new Double[6];
//                     for (int k = 0; k < 6; ++k) {
//                         result[k] = pose.getDouble(k);
//                     }
//                     return result;
//                 }
//             }
