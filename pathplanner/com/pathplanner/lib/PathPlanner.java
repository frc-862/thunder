package frc.thunder.pathplanner.com.pathplanner.lib;

import frc.thunder.pathplanner.com.pathplanner.lib.PathPlannerTrajectory.EventMarker;
import frc.thunder.pathplanner.com.pathplanner.lib.PathPlannerTrajectory.Waypoint;
...
import frc.thunder.pathplanner.org.json.simple.JSONArray;
import frc.thunder.pathplanner.org.json.simple.JSONObject;
import frc.thunder.pathplanner.org.json.simple.parser.JSONParser;
...
public class PathPlanner {
     ...
     */
    public static List<PathPlannerTrajectory> loadPathGroup(String name, boolean reversed,
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(
                ...
                if (w.isStopPoint || i == waypoints.size() - 1) {
                    ...
                    for (EventMarker marker : markers) {
                        if (marker.waypointRelativePos >= waypoints.indexOf(currentPath.get(0))
                            ...
                            currentMarkers
                                    .add(new EventMarker(marker.names, marker.waypointRelativePos
                                            - waypoints.indexOf(currentPath.get(0))));
                        }
                    }
            ...
            for (int i = 0; i < splitWaypoints.size(); i++) {
                ...
                pathGroup.add(new PathPlannerTrajectory(splitWaypoints.get(i), splitMarkers.get(i),
     ...
     * @return A List of all generated paths in the group
     */
    public static List<PathPlannerTrajectory> loadPathGroup(String name, PathConstraints constraint,
     ...
     * @return A List of all generated paths in the group
     */
    public static List<PathPlannerTrajectory> loadPathGroup(String name, double maxVel,
     ...
     * you use this method in competition. Points positioned in weird configurations such as being
     * too close together can lead to really janky paths.
     *
     ...
     * @return The generated path
     */
    public static PathPlannerTrajectory generatePath(PathConstraints constraints, boolean reversed,
        ...
        waypoints.add(new Waypoint(firstPoint.position, null, null, firstPoint.velocityOverride,
                firstPoint.holonomicRotation, false, false, new PathPlannerTrajectory.StopEvent()));
        ...
        for (int i = 1; i < points.size(); i++) {
            ...
            double p1NextDistance =
                    p1.nextControlLength <= 0 ? thirdDistance : p1.nextControlLength;
            double p2PrevDistance =
                    p2.prevControlLength <= 0 ? thirdDistance : p2.prevControlLength;

            Translation2d p1Next =
                    p1.position.plus(new Translation2d(p1.heading.getCos() * p1NextDistance,
                            p1.heading.getSin() * p1NextDistance));
            waypoints.get(i - 1).nextControl = p1Next;

            Translation2d p2Prev =
                    p2.position.minus(new Translation2d(p2.heading.getCos() * p2PrevDistance,
                            p2.heading.getSin() * p2PrevDistance));
            waypoints.add(new Waypoint(p2.position, p2Prev, null, p2.velocityOverride,
                    p2.holonomicRotation, false, false, new PathPlannerTrajectory.StopEvent()));
        }
     ...
     * @param points Points in the path
     * @return The generated path
     * @deprecated For removal in 2024, use
     *             {@link PathPlanner#generatePath(PathConstraints, boolean, List)} instead
     */
    @Deprecated
    public static PathPlannerTrajectory generatePath(double maxVel, double maxAccel,
            boolean reversed, List<PathPoint> points) {
     ...
     * @return The generated path
     */
    public static PathPlannerTrajectory generatePath(PathConstraints constraints,
            List<PathPoint> points) {
     ...
     */
    public static PathPlannerTrajectory generatePath(PathConstraints constraints, boolean reversed,
            PathPoint point1, PathPoint point2, PathPoint... points) {
     ...
     * @return The generated path
     */
    public static PathPlannerTrajectory generatePath(PathConstraints constraints, PathPoint point1,
     ...
     * @return The generated path
     * @deprecated For removal in 2024, use
     *             {@link PathPlanner#generatePath(PathConstraints, PathPoint, PathPoint, PathPoint...)}
     *             instead.
     */
    @Deprecated
    public static PathPlannerTrajectory generatePath(double maxVel, double maxAccel,
    ...
    private static List<Waypoint> getWaypointsFromJson(JSONObject json) {
        ...
        for (Object waypoint : jsonWaypoints) {
            ...
            Translation2d anchorPoint =
                    new Translation2d(((Number) jsonAnchor.get("x")).doubleValue(),
            ...
            if (jsonPrevControl != null) {
                prevControl = new Translation2d(((Number) jsonPrevControl.get("x")).doubleValue(),
            ...
            if (jsonNextControl != null) {
                nextControl = new Translation2d(((Number) jsonNextControl.get("x")).doubleValue(),
                        ((Number) jsonNextControl.get("y")).doubleValue());
            }

            Rotation2d holonomicAngle = null;
            if (jsonWaypoint.get("holonomicAngle") != null) {
                holonomicAngle = Rotation2d
                        .fromDegrees(((Number) jsonWaypoint.get("holonomicAngle")).doubleValue());
            }
            ...
            if (isStopPointObj != null)
                isStopPoint = (boolean) isStopPointObj;
            ...
            if (jsonWaypoint.get("stopEvent") != null) {
                ...
                if (stopEventJson.get("executionBehavior") != null) {
                    PathPlannerTrajectory.StopEvent.ExecutionBehavior behavior =
                            PathPlannerTrajectory.StopEvent.ExecutionBehavior
                                    .fromValue(stopEventJson.get("executionBehavior").toString());
                ...
                if (stopEventJson.get("waitBehavior") != null) {
                    PathPlannerTrajectory.StopEvent.WaitBehavior behavior =
                            PathPlannerTrajectory.StopEvent.WaitBehavior
                                    .fromValue(stopEventJson.get("waitBehavior").toString());
                ...
                stopEvent = new PathPlannerTrajectory.StopEvent(names, executionBehavior,
                        waitBehavior, waitTime);
            }

            waypoints.add(new Waypoint(anchorPoint, prevControl, nextControl, velOverride,
                    holonomicAngle, isReversal, isStopPoint, stopEvent));
        }
        ...
        if (jsonMarkers != null) {
            for (Object marker : jsonMarkers) {
                ...
                if (eventNames != null) {
                    ...
                    // Handle transition between one-event markers and multi-event markers. Remove
                    // next season
                    names.add((String) jsonMarker.get("name"));
                }
                markers.add(new EventMarker(names,
                        ((Number) jsonMarker.get("position")).doubleValue()));
            }
        }
