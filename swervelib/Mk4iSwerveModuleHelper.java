...
public final class Mk4iSwerveModuleHelper {
    ...
    private static DriveControllerFactory<?, Integer> getNeoDriveFactory(
        ...
        return new NeoDriveControllerFactoryBuilder()
                ...
                .withPidConstants(new SparkMaxPIDGains(configuration.getDrivePIDGains().getP(),
                        configuration.getDrivePIDGains().getI(), configuration.getDrivePIDGains().getD(),
                        configuration.getDrivePIDGains().getF()))
                .build();
    }
    ...
    // /**
    // * Creates a Mk4i swerve module that uses Falcon 500s for driving and
    // steering.
    // * Module
    ...
    // * @return The configured swerve module.
    // */
    // public static SwerveModule createFalcon500(Mk4ModuleConfiguration
    // configuration,
    // GearRatio gearRatio, int driveMotorPort, int steerMotorPort,
    // int steerEncoderPort, double steerOffset) {
    // return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
    ...
    // * @return The configured swerve module.
    // */
    // public static SwerveModule createFalcon500(GearRatio gearRatio, int
    // driveMotorPort,
    // int steerMotorPort, int steerEncoderPort, double steerOffset) {
    // return createFalcon500(new Mk4ModuleConfiguration(), gearRatio,
    // driveMotorPort,
    ...
    // /**
    // * Creates a Mk4i swerve module that uses a Falcon 500 for driving and a NEO
    // for
    // * steering.
    ...
    // * @return The configured swerve module.
    // */
    // public static SwerveModule createFalcon500Neo(Mk4ModuleConfiguration
    // configuration,
    // GearRatio gearRatio, int driveMotorPort, int steerMotorPort,
    // int steerEncoderPort, double steerOffset) {
    // return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
    ...
    // * @return The configured swerve module.
    // */
    // public static SwerveModule createFalcon500Neo(GearRatio gearRatio, int
    // driveMotorPort,
    // int steerMotorPort, int steerEncoderPort, double steerOffset) {
    // return createFalcon500Neo(new Mk4ModuleConfiguration(), gearRatio,
    // driveMotorPort,
    // steerMotorPort, steerEncoderPort, steerOffset);
    // }

    // /**
    // * Creates a Mk4i swerve module that uses a NEO for driving and a Falcon 500
    // for
    // * steering.
    // * Module information is displayed in the specified ShuffleBoard container.
    // *
    ...
    // * @return The configured swerve module.
    // */
    // public static SwerveModule createNeoFalcon500(Mk4ModuleConfiguration
    // configuration,
    // GearRatio gearRatio, int driveMotorPort, int steerMotorPort,
    // int steerEncoderPort, double steerOffset) {
    // return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
    ...
    // * @return The configured swerve module.
    // */
    // public static SwerveModule createNeoFalcon500(GearRatio gearRatio, int
    // driveMotorPort,
    // int steerMotorPort, int steerEncoderPort, double steerOffset) {
    // return createNeoFalcon500(new Mk4ModuleConfiguration(), gearRatio,
    // driveMotorPort,
    // steerMotorPort, steerEncoderPort, steerOffset);
    // }
