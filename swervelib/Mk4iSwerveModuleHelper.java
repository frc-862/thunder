...
public final class Mk4iSwerveModuleHelper {
    ...
    private static DriveControllerFactory<?, Integer> getNeoDriveFactory(
        ...
        return new NeoDriveControllerFactoryBuilder()
                ...
                .withPidConstants(new SparkMaxPIDGains(configuration.getDrivePIDGains().getKP(),
                        configuration.getDrivePIDGains().getKI(), configuration.getDrivePIDGains().getKD(),
                        configuration.getDrivePIDGains().getFF()))
                .build();
    }
    ...
    //  */
    // public static SwerveModule createFalcon500(ShuffleboardLayout container,
    //         Mk4ModuleConfiguration configuration, GearRatio gearRatio,
    ...
    //             getFalcon500SteerFactory(configuration)).create(container,
    //                     driveMotorPort,
    //                     new Falcon500SteerConfiguration<>(steerMotorPort,
    ...
    //     return createFalcon500(container, new Mk4ModuleConfiguration(), gearRatio,
    //             driveMotorPort, steerMotorPort, steerEncoderPort, steerOffset);
    // }
    ...
    //  * @return The configured swerve module.
    //  */
    // public static SwerveModule createFalcon500(Mk4ModuleConfiguration configuration,
    //         GearRatio gearRatio, int driveMotorPort, int steerMotorPort,
    //         int steerEncoderPort, double steerOffset) {
    //     return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
    //             getFalcon500DriveFactory(configuration),
    ...
    //  * @return The configured swerve module.
    //  */
    // public static SwerveModule createFalcon500(GearRatio gearRatio, int driveMotorPort,
    //         int steerMotorPort, int steerEncoderPort, double steerOffset) {
    //     return createFalcon500(new Mk4ModuleConfiguration(), gearRatio, driveMotorPort,
    //             steerMotorPort, steerEncoderPort, steerOffset);
    // }

    /**
     * Creates a Mk4i swerve module that uses NEOs for driving and steering. Module
     * information
    ...
    public static SwerveModule createNeo(ShuffleboardLayout container, GearRatio gearRatio,
            int driveMotorPort, int steerMotorPort, int steerEncoderPort,
            double steerOffset) {
        return createNeo(container, new Mk4ModuleConfiguration(), gearRatio, driveMotorPort,
                steerMotorPort, steerEncoderPort, steerOffset);
    }
     ...
     * @return The configured swerve module.
     */
    public static SwerveModule createNeo(Mk4ModuleConfiguration configuration,
            GearRatio gearRatio, int driveMotorPort, int steerMotorPort,
            int steerEncoderPort, double steerOffset) {
        return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
                getNeoDriveFactory(configuration),
    ...
    public static SwerveModule createNeo(GearRatio gearRatio, int driveMotorPort,
            int steerMotorPort, int steerEncoderPort, double steerOffset) {
        return createNeo(new Mk4ModuleConfiguration(), gearRatio, driveMotorPort,
                steerMotorPort, steerEncoderPort, steerOffset);
    }

    // /**
    //  * Creates a Mk4i swerve module that uses a Falcon 500 for driving and a NEO for
    //  * steering.
    ...
    //  * @return The configured swerve module.
    //  */
    // public static SwerveModule createFalcon500Neo(ShuffleboardLayout container,
    //         Mk4ModuleConfiguration configuration, GearRatio gearRatio,
    //         int driveMotorPort, int steerMotorPort, int steerEncoderPort,
    //         double steerOffset) {
    //     return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
    ...
    //         GearRatio gearRatio, int driveMotorPort, int steerMotorPort,
    //         int steerEncoderPort, double steerOffset) {
    //     return createFalcon500Neo(container, new Mk4ModuleConfiguration(), gearRatio,
    //             driveMotorPort, steerMotorPort, steerEncoderPort, steerOffset);
    // }
    ...
    //  * @return The configured swerve module.
    //  */
    // public static SwerveModule createFalcon500Neo(Mk4ModuleConfiguration configuration,
    //         GearRatio gearRatio, int driveMotorPort, int steerMotorPort,
    //         int steerEncoderPort, double steerOffset) {
    //     return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
    //             getFalcon500DriveFactory(configuration),
    ...
    //  * @return The configured swerve module.
    //  */
    // public static SwerveModule createFalcon500Neo(GearRatio gearRatio, int driveMotorPort,
    //         int steerMotorPort, int steerEncoderPort, double steerOffset) {
    //     return createFalcon500Neo(new Mk4ModuleConfiguration(), gearRatio, driveMotorPort,
    //             steerMotorPort, steerEncoderPort, steerOffset);
    // }

    // /**
    //  * Creates a Mk4i swerve module that uses a NEO for driving and a Falcon 500 for
    //  * steering.
    //  * Module information is displayed in the specified ShuffleBoard container.
    //  *
    //  * @param container        The container to display module information in.
    ...
    //  * @return The configured swerve module.
    //  */
    // public static SwerveModule createNeoFalcon500(ShuffleboardLayout container,
    //         Mk4ModuleConfiguration configuration, GearRatio gearRatio,
    //         int driveMotorPort, int steerMotorPort, int steerEncoderPort,
    //         double steerOffset) {
    //     return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
    ...
    //         GearRatio gearRatio, int driveMotorPort, int steerMotorPort,
    //         int steerEncoderPort, double steerOffset) {
    //     return createNeoFalcon500(container, new Mk4ModuleConfiguration(), gearRatio,
    //             driveMotorPort, steerMotorPort, steerEncoderPort, steerOffset);
    // }
    ...
    //  * @return The configured swerve module.
    //  */
    // public static SwerveModule createNeoFalcon500(Mk4ModuleConfiguration configuration,
    //         GearRatio gearRatio, int driveMotorPort, int steerMotorPort,
    //         int steerEncoderPort, double steerOffset) {
    //     return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
    //             getNeoDriveFactory(configuration),
    ...
    //  * @return The configured swerve module.
    //  */
    // public static SwerveModule createNeoFalcon500(GearRatio gearRatio, int driveMotorPort,
    //         int steerMotorPort, int steerEncoderPort, double steerOffset) {
    //     return createNeoFalcon500(new Mk4ModuleConfiguration(), gearRatio, driveMotorPort,
    //             steerMotorPort, steerEncoderPort, steerOffset);
    // }

    public enum GearRatio {
        L1(SdsModuleConfigurations.MK4I_L1), L2(SdsModuleConfigurations.MK4I_L2), L3(
                SdsModuleConfigurations.MK4I_L3);
